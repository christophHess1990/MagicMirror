...
#print("apiKey = "+data['weatherAPI']['api_key'])
f.close()
...
#filepath for images
imageDirectory = fileData['imageDirectory']['directory']
...
def getURL(stringOfLocationAdress):
    ...
    def getLocationParameter(adressString):
        ...
        def stringFormatter(s):
            ...
            resultString = s.replace(" ", "%20")
            resultString = resultString.replace(",", "%2C")
            resultString = resultString.replace("ß", "%C3%9F")
            #replace special chars
            resultString = resultString.replace("Ä", "%C3%84")
            resultString = resultString.replace("ä", "%C3%A4")
            resultString = resultString.replace("Ö", "%C3%96")
            resultString = resultString.replace("ö", "%C3%B6")
            resultString = resultString.replace("Ü", "%C3%9C")
            resultString = resultString.replace("ü", "%C3%BC")
...
if __name__ == '__main__':
    ...
    #setup GUI
    guiWindow = Tk()
    guiWindow.configure(background="black")
